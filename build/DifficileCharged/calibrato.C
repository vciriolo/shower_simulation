...
//=========  (Wed Sep  3 09:53:49 2014) by ROOT version5.34/09
   ...
   gre->SetPoint(0,100,0.3006536);
   gre->SetPointError(0,0,0.001927188);
   gre->SetPoint(1,10,1.171891);
   gre->SetPointError(1,0,0.00805238);
   gre->SetPoint(2,30,0.6120554);
   gre->SetPointError(2,0,0.004008848);
   gre->SetPoint(3,3,2.366448);
   gre->SetPointError(3,0,0.01826407);
   gre->SetPoint(4,300,0.1603727);
   gre->SetPointError(4,0,0.001023248);
   
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","Resolution Worsen Due to Pre-Shower (with energy measurement)",100,0,329.7);
   Graph_Graph1->SetMinimum(0);
   Graph_Graph1->SetMaximum(2.607249);
   ...
   iperbole->SetChisquare(1916.886);
   iperbole->SetNDF(4);
   ...
   iperbole->SetParameter(0,3.212306);
   iperbole->SetParError(0,0.00976285);
